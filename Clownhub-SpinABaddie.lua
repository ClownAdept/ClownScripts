        ...
        while true do
            ...
            if prompt then
                repeat
                    ...
                    task.wait(0.1)
                until player.PlayerGui:FindFirstChild("Main") and player.PlayerGui.Main:FindFirstChild("MerchantShop")
            end

            local shop = player.PlayerGui.Main:FindFirstChild("MerchantShop")
